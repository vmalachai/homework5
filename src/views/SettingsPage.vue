...
//clear all textboxes
    ...
    input.forEach(singleInput => singleInput.value='')

}

</script>
<template>
    <form class="mx-auto mt-10 flex max-w-mf flex-col gap-4 rounded-md bg-white p-8 shadow-lg" @submit.prevent="addEmploye">
